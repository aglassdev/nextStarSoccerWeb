    ...
    <div className="min-h-screen bg-black flex flex-col">
      ...
      <div className="flex-1 pt-28 pb-20 px-4">
        <div className="max-w-3xl mx-auto">
          ...
          {/* Header */}
          <div className="mb-10">
            <p className="text-white/40 text-xs tracking-[0.2em] uppercase mb-3">2026 Season</p>
            <h1 className="text-white text-4xl font-bold leading-tight">Summer Camps</h1>
            <p className="text-white/50 mt-3 text-base leading-relaxed max-w-lg">
              ...
              >
                <div className="relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[#0d0d0d] hover:border-white/20 transition-all duration-300">
                  <div className="flex h-48 sm:h-52">
                    ...
                    {/* Image */}
                    <div className="w-2/5 sm:w-1/3 relative flex-shrink-0 overflow-hidden">
                      <img
                        src={camp.image}
                        alt={camp.name}
                    ...
                    {/* Content */}
                    <div className="flex-1 flex flex-col justify-center px-5 py-5 sm:px-7 min-w-0">
                      ...
                      <div className="flex flex-wrap gap-2">
                        {camp.sessions.map(s => (
                          <span
                            key={s.label}
                            className="text-[11px] text-white/50 border border-white/[0.12] rounded-md px-2.5 py-1 leading-none"
                          >
                            {s.label} · {s.time}
                          </span>
                        ))}
